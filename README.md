...
An HTML Canvas 2D demonstration with no runtime dependencies, served locally with Vite, of spatial indexing, circle collisions, and ball tracking.
...
- `src/main.js`: accumulator-driven animation loop, high-DPI renderer, pointer selection, controls and inspector.
